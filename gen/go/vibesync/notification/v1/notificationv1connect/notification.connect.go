...
import (
	...
	http "net/http"
	strings "strings"
	v1 "vibesync/gen/go/vibesync/notification/v1"
)
...
const (
	...
	NotificationServiceName = "vibesync.notification.v1.NotificationService"
)
...
const (
	...
	NotificationServiceSendNotificationProcedure = "/vibesync.notification.v1.NotificationService/SendNotification"
)

// NotificationServiceClient is a client for the vibesync.notification.v1.NotificationService
// service.
...
// vibesync.notification.v1.NotificationService service. By default, it uses the Connect protocol
...
func NewNotificationServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) NotificationServiceClient {
	...
	notificationServiceMethods := v1.File_vibesync_notification_v1_notification_proto.Services().ByName("NotificationService").Methods()
...
// SendNotification calls vibesync.notification.v1.NotificationService.SendNotification.
...
// vibesync.notification.v1.NotificationService service.
...
func NewNotificationServiceHandler(svc NotificationServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/vibesync.notification.v1.NotificationService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedNotificationServiceHandler) SendNotification(context.Context, *connect.Request[v1.SendNotificationRequest]) (*connect.Response[v1.SendNotificationResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("vibesync.notification.v1.NotificationService.SendNotification is not implemented"))
}
